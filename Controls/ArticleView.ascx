...
<div class="ArticleAdmin" runat="server" id="ArticleAdmin">
    <asp:LinkButton id="lnkEdit" runat="server" resourcekey="EditArticle" onclick="EditClick" />
    <asp:LinkButton ID="lnkDelete" runat="server" ResourceKey="DeleteArticle" onclick="DeleteClick" />
</div>